...
- Clone this repo
- Create a new python virtual environment (works on 3.10 for me)
...
- Multiple experiments can be queued via `dvc exp run --queue --set-param "train.batch_size=8,16,24"` for example.
